...
<!-- SECTION DE LA RESERVATION ............................................ -->
	...
	<br/><br/>
	<input type="submit" name="sub1" value="Soumettre"/>
<br/>
...
<form id="cancel" method="POST" action="<?PHP $_PHP_SELF ?>">
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		if (isset($_POST['sub1'])) {
			...
			$permit = mysqli_query($conn,"select * from reservation where ID_RA='".$_SESSION["ID_A"]."' AND DATE_R='".$dateRes."'")or die(mysqli_error($conn));
	...
	//Date_R, Hour_R, Date_RD, ID_RA, ID_RT
			...
			if(strcmp($currentDay,"Saturday")!=0){ //.......................................CHANGER LE JOUR ICI ET A ADMIN_RESERVE.........................$$$$$$$$$$$$$
			...
			if ($_POST['test'] == 'chkBox'){
				$cancelRes = mysqli_query($conn,"delete from reservation where ID_RA='".$_SESSION["ID_A"]."' AND DATE_R='".$dateOfTmr."'")or die(mysqli_error($conn));
